...
Эти свойства позволяют скрыть объект. Отличие в том, что hide_viewport отвечает за отображение объекта на сцене, а hide_render — за отображение на конечном изображении.
